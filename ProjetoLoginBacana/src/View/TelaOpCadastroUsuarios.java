...
public class TelaOpCadastroUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnInserirUsuario.setText("NOVO USUARIO");
    ...
    private void btnAtualizarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarUsuarioActionPerformed
       //email, login, perfil
        ...
        Integer linhaSelecionada = tbListaUsuarios.getSelectedRow();
        String id_user = tbListaUsuarios.getValueAt(linhaSelecionada, 0).toString();
        CadastroUsuariosController filtro = new CadastroUsuariosController();
        ArrayList<CadastroUsuarioModel> lista = filtro.selecionarUserController(id_user);
            
        //Abre a janela da tela de Atualização de usuário
        //TelaAtualizacaoUsuario tela = new TelaAtualizacaoUsuario();
        TelaAtualizacaoUsuarioMVC tela = new TelaAtualizacaoUsuarioMVC();
        for(CadastroUsuarioModel usario : lista){
            tela.atualizaCamposTela(usario);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        TelaCadastroNovoCliente novaTela = new TelaCadastroNovoCliente();
        novaTela.setVisible(true);
