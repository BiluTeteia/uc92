...
public class CadastroUsuariosController {
    ...
    public void resetarSenhaUsuarioController (String id_user, String password){
        CadastroUsuarioModel oper = new CadastroUsuarioModel(id_user, null, null, null, password, null);
        oper.resetarSenhaUsuarioModel(oper);
    }
    
    public ArrayList<CadastroUsuarioModel> selecionarUserController(String id_user){
        CadastroUsuarioModel oper = new CadastroUsuarioModel();
        return oper.selecionarUserModel(id_user);
    }
