...
public class CadastroUsuarioModel extends LoginModel {
    ...
    public void resetarSenhaUsuarioModel(CadastroUsuarioModel senhaResetada){
        GerenciadorBancoDados oper = new GerenciadorBancoDados();
        oper.resetarSenhaUsuario(senhaResetada);
    }
    
    public ArrayList<CadastroUsuarioModel> selecionarUserModel(String id_user){
    
        GerenciadorBancoDados oper = new GerenciadorBancoDados();
        return oper.selecionarUser(id_user);
    }
